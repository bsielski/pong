...
Components.sprites[leftWall] = {width: 40, height: Config.WORLD_HEIGHT, image: LOLPIXELS, opacity: 1.0};
...
Components.sprites[rightWall] = {width: 40, height: Config.WORLD_HEIGHT, image: LOLPIXELS, opacity: 1.0};
...
Components.sprites[toptWall] = {width: Config.WORLD_WIDTH, height: 40, image: LOLPIXELS, opacity: 1.0};
...
Components.sprites[bottomWall] = {width: Config.WORLD_WIDTH, height: 40, image: LOLPIXELS, opacity: 1.0};
...
const skull1 = 11;
Components.sprites[skull1] = {width: 110, height: 110, image: SKULL, opacity: 0.4};
Components.positions[skull1] = {x: 500, y: 140};

const skull2 = 12;
Components.sprites[skull2] = {width: 110, height: 110, image: SKULL, opacity: 0.4};
...
Components.texts[bottomCounter] = {size: 26, content: "0", opacity: 0.6};
...
Components.texts[topCounter] = {size: 26, content: "0", opacity: 0.6};
