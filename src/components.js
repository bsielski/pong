...
const leftWall = 4;
Components.bodies[leftWall] = {width: 20, height: Config.WORLD_HEIGHT, type: "immobile"};
...
const rightWall = 5;
Components.bodies[rightWall] = {width: 20, height: Config.WORLD_HEIGHT, type: "immobile"};
...
const toptWall = 6;
Components.bodies[toptWall] = {width: Config.WORLD_WIDTH, height: 20, type: "immobile"};
...
const bottomWall = 7;
Components.bodies[bottomWall] = {width: Config.WORLD_WIDTH, height: 20, type: "immobile"};
