...
function getLevel01intro() {
  ...
  Components.positions[leftZoneId] = {x: Config.WORLD_WIDTH/4, y: Config.WORLD_HEIGHT - 25, angle: 0};
  ...
  Components.positions[rightZoneId] = {x: Config.WORLD_WIDTH/4*3, y: Config.WORLD_HEIGHT - 25, angle: 0};
