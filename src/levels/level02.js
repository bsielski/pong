...
function getLevel02() {
  ...
  Components.positions[obstacle2Id] = {x: Const.WORLD_WIDTH/2+70, y: Const.WORLD_HEIGHT/3+20, angle: 0.4};
  ...
  Components.positions[obstacle3Id] = {x: Const.WORLD_WIDTH-50, y: Const.WORLD_HEIGHT/3, angle: 2};
